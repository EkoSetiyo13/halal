...
class FrontController extends Controller
{
    public function index()
    {
        ...
        $penerima = FormPenerimaQurban::where('status', '=', 1)->orderBy('created_at', 'DESC')->paginate(10);
        $penyuplai = FormPenyuplaiQurban::where('status', '=', 1)->orderBy('created_at', 'DESC')->paginate(10);
        $post1  = Post::find(1);
