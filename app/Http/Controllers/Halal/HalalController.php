...
class HalalController extends Controller
{
    ...
    {
        $id = $no_binaan;
        $binaan = Umkm::Where('nama_umkm', '!=', '-')->where('status', '=', true)->where('no_umkm', $id)->first();
        ...
        return view('halal.home.detail-binaan', compact('binaan', 'qrcode', 'qrcodeWithLogo', 'downloadQrcodeWithLogo', 'downloadQrCode', 'jsonld'));
    }
