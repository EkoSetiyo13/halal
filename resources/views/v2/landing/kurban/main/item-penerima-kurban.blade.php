...
@section('content')
    @php
    $values = explode(',', $penerima->pengiriman);
    @endphp
        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" class="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200"
                    src="{{ asset('storage/penyedia-kurban/' . $penerima->image) }}">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">Nama penerima</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{ $penerima->name }}</h1>
                    <div class="flex mb-4">
                  ...
                  <span class="text-gray-600 ml-3">4 Reviews</span>
                    ...
                    <p class="leading-relaxed">{{ $penerima->description }}</p>
                    ...
                    <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                        ...
                        <div class="flex ml-6 items-center">
                            <span class="mr-3">
                                <a class="ml-2 text-gray-500"
                                    href="https://api.whatsapp.com/send?phone=62{{ substr($penerima->no_wa, 1) }}&text=Assalamualaikum,">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
