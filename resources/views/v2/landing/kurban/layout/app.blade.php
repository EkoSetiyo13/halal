            ...
            <div class="flex flex-wrap">
                <div class="w-5/6 sm:w-1/2 p-6">
                    ...
                    <p class="text-gray-600 mb-8">
                        Seseorang atau sekelompok orang yang menjual hewan qurban kepada orang yang akan melakukan
                        kurban untuk diberikan kepada penerima kurban berupa hewan hidup dengan semua jenis sesuai
                        dengan syariat
                        <br />
                        <b>Opsi 1 : </b>
                        lakukan registrasi dan isi dashboard sesuai dengan field yang disediakan
                        <br /> <b>Opsi 2 : </b>
                        hubungi admin admin untuk mendaftar dan mengupdate kondisi sesuai format yang
                        disediakan
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        ...
                        <p class="text-gray-600 mb-8">
                            Sekelompok atau instansi yang membutuhkan hewan qurban untuk dibagikan kepada masyarakat
                            yang membutuhkan seperti masjid, yayasan , sekolah dan lainnya
                            <br />
                            <b>Opsi 1 :</b> lakukan registrasi dan isi dashboard sesuai dengan field yang disediakan
                            <br />
                            <b> Opsi 2 : </b> hubungi admin melaluai admin untuk mendaftar dan mengupdate kondisi sesuai
                            format
                            yang disediakan
                            <br />
                            <button
        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="w-full mb-4">
                <img style="display: block; margin-left: auto; margin-right: auto;"
                    class="w-3/4 border-indigo-700 border-4 border-opacity-100"
                    src="{{ asset('/ecommerce/img/image-header-satu.jpeg') }}" />
            </div>
        </div>
    </section>

    <section class="text-white-600 body-font primary">
