@extends('v2.dashboard.layout.app')
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ asset('v2/dashboard/assets/img/flags/id.png') }}"
                                                                alt="indonesia">
                                                        </div>
                                                    </td>
                                                    <td>Indonesia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ asset('v2/dashboard/assets/img/flags/us.png') }}"
                                                                alt="united states">
                                                        </div>
                                                    </td>
                                                    <td>USA</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ asset('v2/dashboard/assets/img/flags/au.png') }}"
                                                                alt="australia">
                                                        </div>
                                                    </td>
                                                    <td>Australia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ asset('v2/dashboard/assets/img/flags/ru.png') }}"
                                                                alt="russia">
                                                        </div>
                                                    </td>
                                                    <td>Russia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ asset('v2/dashboard/assets/img/flags/cn.png') }}"
                                                                alt="china">
                                                        </div>
                                                    </td>
                                                    <td>China</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{ asset('v2/dashboard/assets/img/flags/br.png') }}"
                                                                alt="brazil">
                                                        </div>
                                                    </td>
                                                    <td>Brasil</td>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ asset('v2/dashboard/assets/img/logoproduct.svg') }}" alt="..."
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="{{ asset('v2/dashboard/assets/img/logoproduct3.svg') }}" alt="..."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-list">
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ asset('v2/dashboard/assets/img/jm_denis.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ asset('v2/dashboard/assets/img/chadengle.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ asset('v2/dashboard/assets/img/talha.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="{{ asset('v2/dashboard/assets/img/mlane.jpg') }}" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
