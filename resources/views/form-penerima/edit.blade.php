    ...
    <main class="main">
        ...
        <div class="container-fluid">
            <div class="animated fadeIn">
                <form action="{{ route('form-penerima.update', $penerima->id) }}" method="post"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{ $penerima->name }}"
                                            required>
                                        <p class="text-danger">{{ $errors->first('name') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="no_wa">No Whatsapp (contoh : 085xxxxxxxxx)</label>
                                        <input type="text" id="int5" name="no_wa" class="form-control"
                                            value="{{ $penerima->no_wa }}" required>
                                        <p class="text-danger">{{ $errors->first('no_wa') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="status">Status</label>
                                        <select name="status" class="form-control" required>
                                            <option value="1" {{ $penerima->status == '1' ? 'selected' : '' }}>Publish
                                            </option>
                                            <option value="0" {{ $penerima->status == '0' ? 'selected' : '' }}>Draft
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alamat" class="form-control"
                                            value="{{ $penerima->alamat }}" required>
                                        <p class="text-danger">{{ $errors->first('alamat') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Deskripsi</label>
                                        <textarea name="description" id="description"
                                            class="form-control">{{ $penerima->description }}</textarea>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="int" name="jumlah_warga" class="form-control"
                                            value="{{ $penerima->jumlah_warga }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="int" name="jumlah_sapi" class="form-control"
                                            value="{{ $penerima->jumlah_sapi }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="int1" name="jumlah_kambing" class="form-control"
                                            value="{{ $penerima->jumlah_kambing }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="int2" name="jumlah_kerbau" class="form-control"
                                            value="{{ $penerima->jumlah_kerbau }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="int3" name="jumlah_lain" class="form-control"
                                            value="{{ $penerima->jumlah_lain }}" required>
                                        <p class="text-danger">{{ $errors->first('jumlah_lain') }}</p>
                                    </div>
                                    <div class="form-group">
                                        <label for="image">Foto Produk</label>
                                        <br>
                                        <img src="{{ asset('storage/penerima-kurban/' . $penerima->image) }}"
                                            width="100px" height="100px" alt="{{ $penerima->name }}">
                                        <hr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="is_pelapor" class="form-control" required>
                                            <option value="1" {{ $penerima->is_pelapor == '1' ? 'selected' : '' }}>Ya
                                            </option>
                                            <option value="0" {{ $penerima->is_pelapor == '0' ? 'selected' : '' }}>Tidak
                                            </option>
                                        </select>
