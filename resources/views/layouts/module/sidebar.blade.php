<ul class="navbar-nav">
    @if (Auth::user()->is_admin == true)
        <li class="nav-item">
            <a class="nav-link" href="#dashboard" data-toggle="collapse" role="button" aria-expanded="false"
    ...
    <li class="nav-item">
        <a class="nav-link" href="#navbar-web" data-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="navbar-dashboard">
    ...
    <li class="nav-item">
        <a class="nav-link" href="#navbar-umkm" data-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="navbar-dashboard">
