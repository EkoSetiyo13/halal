											...
											<tbody>
												<tr>
													<td class="text-center">
														<h5 style="color: black"> Nomer Kader : {{$binaan->no_umkm}} </h5>
														<a href="data:image/png;base64, {!! base64_encode($downloadQrCodeKader) !!} " download>
															<img src="data:image/png;base64, {!! base64_encode($qrcodeKader) !!} ">
														</a>
														...
														<textarea readonly rows="15" id="myQrCode" name="description" placeholder="informasi mengenai deskripsi yang menarik" id="description" class="form-control"><a href="http://halal.its.ac.id/kader/{{$binaan->no_umkm}}"><img src="data:image/png;base64, {!! base64_encode($qrcodeKader) !!} "></a></textarea>		
													</td>
												</tr>
										...
										<table class="table">
											<tbody>
												...
												<tr>
													<td class="text-center">
														<h5 style="color: black"> Nomer Kader : {{$binaan->no_umkm}} </h5>
														<a href="data:image/png;base64, {!! base64_encode($downloadQrcodeWithLogoKader) !!} " download>
															<img src="data:image/png;base64, {!! base64_encode($qrcodeWithLogoKader) !!} ">
														</a>
														<p>*Pasang kode ini di web anda untuk menampilkan QRcode anda di web</p>
														<p> <b>*Berlaku hingga Agustus 2020</b> </p>
														<button style="margin-bottom : 10px" type="button" onclick="CopyLogo()" class="btn btn-primary">Copy</button>
														<textarea readonly rows="15" id="myQrCodeLogo" name="description" placeholder="informasi mengenai deskripsi yang menarik" id="description" class="form-control"><a href="http://halal.its.ac.id/kader/{{$binaan->no_umkm}}"><img src="data:image/png;base64, {!! base64_encode($qrcodeWithLogoKader) !!} "></a></textarea>
													</td>
												</tr>
