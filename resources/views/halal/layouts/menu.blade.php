<ul class="nav navbar-nav mr-auto center_nav pull-right">
    ...
    <li class="scroll-to-section nav-item"><a class="nav-link" style="color:white"
            href="{{ route('halal') }}#about">Tentang
            Kami</a></li>
    <li class="scroll-to-section nav-item"><a class="nav-link" style="color:white"
            href="{{ route('halal') }}#services">UMKM</a>
    </li>
    <li class="scroll-to-section nav-item"><a class="nav-link" style="color:white"
    ...
    <li class="submenu nav-item"><a class="nav-link" style="color:white" href="javascript:;">DAFTAR BINAAN</a>
        <ul>
            <li class="scroll-to-section nav-item"><a class="nav-link" href="{{ route('binaan') }}">Binaan UMKM</a>
            </li>
            <li class="scroll-to-section nav-item"><a class="nav-link" href="{{ route('kader') }}">Binaan Kader</a>
            </li>
        </ul>
    </li>
    <li class="submenu nav-item"><a class="nav-link" style="color:white" href="javascript:;">Dosen & Mahasiswa</a>
        <ul>
            ...
            <li class="scroll-to-section nav-item"><a class="nav-link"
                    href="{{ route('data.mahasiswa') }}">Mahasiswa</a></li>
        </ul>
    </li>
    ...
    @if (Route::has('login'))
        ...
        @else
            <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}" style="color:white">Masuk</a>
            </li>
        @endauth
    @endif
</ul>
