...
<head>
  ...
  <meta name="description"
        content="pusat kajian halal ITS, ITS, Umkm, halal, Institut Teknologi Sepuluh Nopember, PKH, Kajian, Pusat">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <p style="font-size: 10px; color : white; text-align: center;" class="copyright">Copyright &copy; 2020 Art
          Factory Company</p>
      </div>
    </div>
  </div>
