                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset('storage/penyedia-kurban/' . $penyuplai->image) }}" width="100px" height="100px" alt="{{ $penyuplai->name }}">
                                    <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset('storage/penyedia-kurban/' . $penyuplai->image2) }}" width="100px" height="100px" alt="{{ $penyuplai->name }}">
                                    <hr>
                                ...
                                <div class="form-group">
                                    <label>Foto Produk</label>
                                    <br>
                                    <img src="{{ asset('storage/penyedia-kurban/' . $penyuplai->image3) }}" width="100px" height="100px" alt="{{ $penyuplai->name }}">
                                    <hr>
