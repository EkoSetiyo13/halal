    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="no_umkm" class="form-control" value="{{ old('no_umkm') ?? $umkm->no_umkm ?? null }}"
                 placeholder="{{ date("Y").'-XXXX' }}" required>
          @component('layouts.components.input_error', ['active' => $errors->has('no_umkm'), 'msg'=> $errors->first('no_umkm')])
          @endcomponent
        </div>
        <div class="form-group">
          <label for="nama_umkm" class="form-control-label">Nama UMKM<span
                class="text-danger">*</span></label>
          <input type="text" name="nama_umkm" class="form-control"
                 value="{{ old('nama_umkm') ?? $umkm->nama_umkm ?? null }}"
        ...
        <div class="form-group">
          ...
          <input type="text" name="nama_pemilik" class="form-control"
                 value="{{ old('nama_pemilik') ?? $umkm->nama_pemilik ??null }}"
        ...
        <div class="form-group">
          <label for="tipe_binaan" class="form-control-label">Tipe Binaan<span
                class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <input type="text" name="pirt" class="form-control" value="{{ old('pirt') ?? $umkm->pirt ?? null }}"
                 placeholder="Nomor P-IRT">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="alamat" class="form-control" value="{{ old('alamat') ?? $umkm->alamat ?? null }}"
                 required>
        ...
        <div class="form-row">
          <label for="desa" class="form-control-label col">Desa <span class="text-danger">*</span>
            <input type="text" name="desa" class="form-control" value="{{ old('desa') ?? $umkm->desa ?? null }}"
                   required>
          ...
          <label for="kecamatan" class="form-control-label col">Kecamatan <span class="text-danger">*</span>
            <input type="text" name="kecamatan" class="form-control"
                   value="{{ old('kecamatan') ?? $umkm->kecamatan ?? null }}" required>
        ...
        <div class="form-group">
          ...
          <input type="text" name="google_map" class="form-control"
                 value="{{ old('google_map') ?? $umkm->google_map ?? null }}"
                 placeholder="https://www.google.com/maps/place/Sepuluh+Nopember+Institute+of+Technology+(ITS)/@-7.2762443,112.7986227,15z/data=!4m5!3m4!1s0x2dd7fa1323221a93:0x306c3c99adedb258!8m2!3d-7.282356!4d112.7949253">
      ...
      <div class="card-body">
        <div class="form-row">
          <div class="col-md-6 mb-3">
            <label class="form-control-label" for="no_wa">No Whatsapp<span
                  class="text-danger">*</span></label>
            <input type="text" name="no_wa" class="form-control" value="{{ old('no_wa') ?? $umkm->no_wa ?? null }}"
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="email" class="form-control" value="{{ old('email') ?? $umkm->email ?? null }}"
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="instagram" class="form-control"
                   value="{{ old('instagram') ?? $umkm->instagram ?? null }}"
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="facebook" class="form-control"
                   value="{{ old('facebook') ?? $umkm->facebook ?? null }}"
                   placeholder="https://www.facebook.com/InstitutTeknologiSepuluhNopember">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="tokopedia" class="form-control"
                   value="{{ old('tokopedia') ?? $umkm->tokopedia ?? null }}"
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="shopee" class="form-control" value="{{ old('shopee') ?? $umkm->shopee ?? null }}"
                   placeholder="Shopee">
          ...
          <div class="col-md-6 mb-3">
            ...
            <input type="text" name="bukalapak" class="form-control"
                   value="{{ old('bukalapak') ?? $umkm->bukalapak ?? null }}"
      ...
      <div class="card-body">
        <div class="form-group">
          <label for="nama_produk" class="form-control-label">Nama Produk<span
                class="text-danger">*</span></label>
          <input type="text" name="nama_produk" class="form-control"
                 value="{{ old('nama_produk') ?? $umkm->nama_produk ?? null }}"
                 required>
        ...
        <div class="form-group">
          ...
          <input type="text" name="bpom" class="form-control" value="{{ old('bpom') ?? $umkm->bpom ?? null }}"
                 placeholder="Izin BPOM">
        ...
        @if(!empty($umkm->image ?? null))
          <div class="row justify-content-center">
            <img class="img-responsive" src="{{ asset('storage/products/' . $umkm->image) }}" style="max-height: 300px"
                 alt="{{ $umkm->nama_umkm.'-'.$umkm->nama_produk}}">
          </div>
        @endif
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="video" class="form-control" value="{{ old('video') ?? $umkm->video ?? null }}"
