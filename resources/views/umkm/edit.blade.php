              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_pemilik" class="form-control" value="{{ $umkm->nama_pemilik }}"
                           required>
                    <p class="text-danger">{{ $errors->first('2') }}</p>
                  </div>
                  <div class="form-group">
                    <label for="3">Nama Produk</label>
                    <input type="text" name="nama_produk" class="form-control" value="{{ $umkm->nama_produk }}"
                           required>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    @if(!empty($umkm->image ?? null))
                      <img src="{{ asset('storage/products/' . $umkm->image) }}" width="300px" height="300px"
                           alt="{{ $umkm->nama_pemilik }}">
                    @endif
                    <hr>
