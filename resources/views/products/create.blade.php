                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="jenis_ternak_id">Jenis Ternak</label>
                                    <select name="jenis_ternak_id" class="form-control">
                                        <option value="">Pilih</option>
                                        @foreach ($jenisTernak as $row)
                                        <option value="{{ $row->id }}" {{ old('jenis_ternak_id') == $row->id ? 'selected':'' }}>{{ $row->name }}</option>
                                        @endforeach
                                    </select>
                                    <p class="text-danger">{{ $errors->first('jenis_ternak_id') }}</p>
                                </div>
                                <div class="form-group">
